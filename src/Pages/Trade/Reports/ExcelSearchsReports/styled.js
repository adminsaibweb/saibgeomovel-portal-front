...
export const ContentTitleNewReports = styled.div`
  display: flex;
  flex-direction: row;
...
export const ContentIconMoreInfo = styled.div`
  display: flex;
  align-items: center;
...
export const BodyDropDownInformationReport = styled.div`
...
export const Li = styled.li`
  text-align: initial;
  font-weight: ${(props) => (props.titleLi ? '700' : 'unset')};
  border-bottom: ${(props) => !props.withOutBorder && '1px solid #ccc'};
  padding: ${(props) => props.withOutPadding && '10px 0 10px 10px!important'};
  user-select: text;
...
export const UlOverUl = styled.ul`
  display: flex;
  flex-wrap: wrap;
  max-width: ${(props) => (props.maxWidth ? `calc(${props.maxWidth} - 10px)` : 'unset')};
`;

export const ContentNewsReports = styled.div`
  flex: 1;
...
export const ContentListReports = styled.div``;
